...
const SearchVideoPage = () => {
    ...
    useEffect(() => {
        if (login === "true") {
            ...
            axios.post('http://localhost:5000/api/searchVideosByTitle', { title: title })
                .then((videosResponse) => {
                    const videosData = videosResponse.data.videos;
                        ...
                        <React.Fragment>
                            {isLoading || login !== "true" ? (
                                <div className="w-full h-screen flex justify-center items-center">
                                    <h1 className="text-2xl text-gray-500">Không tìm thấy nội dung tìm kiếm liên quan</h1>
                                </div>
                            ) : (
                        ...
                        videos.map((video, index) => (
                            <div key={index} className="flex justify-center items-center" >
                                <div className="flex flex-wrap justify-center items-center mb-8">
                                    <div className="flex justify-center min-w-[1000px] min-h-[675px] max-w-[1000px] max-h-[675px] px-5 bg-gray-50 rouder-xl  rounded-2xl border shadow">
