...
const AdminChangeCategoryPage = ({ closeModal, values }) => {
    //console.log(values.id);
    // console.log(category_Name);
    // console.log(category_Motto);
    ...
    const inputMotto = formik.values.motto === values.motto ? values.motto : formik.values.motto;
...
export default AdminChangeCategoryPage;